...
const SUPABASE_KEY = 'sb_publishable_3dP43cl1nBPMCJXHyZcVbw_yPQkZVKq'; // ← ضع Anon Key الصح من Supabase Dashboard هنا
  ...
  async getAll() {
    try {
      ...
      if (Array.isArray(data)) {
        // دايماً حدّث الكاش بأحدث بيانات من Supabase
