...
function setColor(c, el){
  // ✅ FIX #7: دايماً نحدّث الـ active dot — حتى لو مفيش el
  if(c==='orange'){
  ...
  // أزل active من الكل وحط على اللي اتضغط
  document.querySelectorAll('.tdot').forEach(d => {
    const bg = d.style.background || '';
    const colorMap = { green:'#00d4aa', blue:'#3b82f6', purple:'#a855f7', orange:'#f97316' };
    d.classList.toggle('active', bg === colorMap[c]);
  });
